...
4. Run the Burgers integrated comparison with soft, hard-IC/BC, and bounded hard-IC/BC variants.
5. Run the Burgers diagnostic comparison with amplitude-2 bounded correction and shock-focused sampling.
6. Run the HardNet++ circle comparison to verify nonlinear equality enforcement.
7. Prepare the midterm resume using `midterm_resume_plan.md` and `hardnet_transition_plan.md`.
